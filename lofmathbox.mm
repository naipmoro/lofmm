...
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  ...
  This mathbox version reuses the alpahabet of set.mm's propositional calculus.
  In addition, we use the left and right brackets, "[" and "]", as designators
  of LoF's boundary mark.
$)
...
$)
  ...
  ${
    ...
    $( Read this as:  "If ` ph ` is equal to ` ps ` , then we can infer that
       ...
       26-Jan-2017.) $)
    ax-lofsub $a |- [ [ ph ze ] [ ps ze ] ] [ ph ze ps ze ] $.
  $}
...
$)
  ...
  $( Occultation.  Theorem C4 of [Spencer-Brown] p. 33.  (Contributed by
     Naipmoro, 6-Sep-2015.) $)
  lofc4 $p |- [ [ ph ] ps ] ph = ph $=
    ( df-lofencl df-lofjuxt df-lofvoid ax-lofj2 lofc1 lofsubb1 loftrans lofeucr
    lofc5 lofc3 lofsubst ) ACZBDCADZECZCZADZAOPBCZCZDZCADZRONSADCZDCZUBAADZCZUC
    DCZOUDUGNTDCADOASAFTBNEEABGHIUFNEUCEEUEAEEEEAKHHJESAFIUAPEEEATLHIQEEAEGMI
    $.
...
$)
  ...
  $( ~ ax-lofj1 extended.  (Contributed by Naipmoro, 14-Feb-2017.) $)
  ...
  $( ~ ax-lofj1 reversed and extended.  (Contributed by Naipmoro,
     25-Feb-2017.) $)
  ...
  $( ~ ax-lofj1 extended and switched.  (Contributed by Naipmoro,
     14-Feb-2017.) $)
  ...
  $( ~ ax-lofj2 extended.  (Contributed by Naipmoro, 14-Feb-2017.) $)
  ...
  $( ~ ax-lofj2 reversed and extended.  (Contributed by Naipmoro,
     14-Feb-2017.) $)
...
$)
  ...
  $( Proving axiom ~ ax-1 as a theorem.  (Contributed by Naipmoro,
     14-Feb-2017.) $)
  _ax-1 $p |- ( ph -> ( ps -> ph ) ) $=
  ...
  $( Proving axiom ~ ax-2 as a theorem.  (Contributed by Naipmoro,
     14-Feb-2017.) $)
  _ax-2 $p |- ( ( ph -> ( ps -> ch ) ) -> ( ( ph -> ps ) -> ( ph -> ch ) ) ) $=
  ...
  $( Proving axiom ~ ax-3 as a theorem.  (Contributed by Naipmoro,
     14-Feb-2017.) $)
  _ax-3 $p |- ( ( -. ph -> -. ps ) -> ( ps -> ph ) ) $=
...
$)
  ...
  $( Proving ~ dfbi1 directly from LoF. (Contributed by Naipmoro,
     4-Mar-2017.) $)
  _dfbi1 $p |- ( ( ph <-> ps ) <-> -. ( ( ph -> ps ) -> -. ( ps -> ph ) ) ) $=
    ( wb wi wn lofbi1 lofeqbi ) ABCABDBADEDEABFG $.

  $( Proving ~ bi1 directly from LoF. (Contributed by Naipmoro,
     24-Feb-2017.) $)
  _bi1 $p |- ( ( ph <-> ps ) -> ( ph -> ps ) ) $=
