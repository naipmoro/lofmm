...
proves the associativity of conjunction, but now I will prove that more
...
utilize metamath's proof-disply capabilities.]

This shows that a permutation of variables in the LHS is irrelevant.
Specifically, _\((((q)(r))) (p))_, which is equal to _\((p) (((q)(r))))_ by
commutation, will evaluate to the same form as _\((((p)(q))) (r))_. This
completes the proof. I call this meta-reasoning because we're using an
undefined, intuitive notion of symmetry. See the source for the full-length
formal proof.
...
_\(((p)q) ((q)p))_, was equivalent to _\((p)(q)) (p q)_. See the source
for a proof of that.
